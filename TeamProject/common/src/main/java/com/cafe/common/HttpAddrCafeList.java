...
public class HttpAddrCafeList {

    public List<ModelCafeinfo> addr(String addr){
        String weburl = "http://192.168.0.52:8080/team/getCafeListAddr";
        ...
        try {
            ...
            request.addParameter("cafeaddr", addr);
